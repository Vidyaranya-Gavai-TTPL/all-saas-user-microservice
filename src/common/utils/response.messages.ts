export const API_RESPONSES = {
  ...
  INVITEDUSER_CONFLICT: (admin) =>
    `Invited user is already a ${admin} of invited cohort`,
  TENANT_EXISTS: "Tenant already exists",
  TENANT_NAME_EXISTS: (name) =>
    `Tenant with name ${name} already exists. Cannot Update`,
  ...
  TENANT_COHORT_EXISTS:
    "Access denied, Cohorts are associated with this tenant.",
  ...
  COHORTMEMBER_COHORT_EXIST:
    "Access denied, Cohortmembers are associated with this Cohort.",
